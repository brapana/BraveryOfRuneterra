...
def home_page():
    ...
    (or pick two random regions).
    Database use disabled due to AWS costs (code in comments).
    '''
    ...
    return render_template('index.html', selected_regions=selected_regions, random_regions=random_regions,
                            formatted_deck_info=formatted_deck_info, deck_count=0, regions=lor_bravery.ALL_REGIONS)
